...
public class Login extends JFrame {
    ...
    private void initComponents() {
        ...
        this.jButton1.setBackground(new Color(255, 255, 0));
        ...
        this.jLabel3.setText("Inventory App");
        ...
        this.jTable1.setModel(new DefaultTableModel(new Object[][]{{"admin", "default", "administrator"}}, new String[]{"Username", "Password", "Type"}) {
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        ...
        if (username.isEmpty()) {
            JOptionPane.showMessageDialog(this.rootPane, "Invalid username", "Error", 2);
        } else if (password.isEmpty()) {
            JOptionPane.showMessageDialog(this.rootPane, "Invalid password", "Error", 2);
        } else if (username.equals("admin") && password.equals("default")) {
